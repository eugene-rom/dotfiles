...
" Modified file
let s:NM3 = [ '#5f005f' , '#5fff87' , 53 , 84  ] " guifg guibg ctermfg ctermbg
...
let g:airline#themes#my_theme#palette.normal_modified = copy(g:airline#themes#my_theme#palette.normal)
let g:airline#themes#my_theme#palette.normal_modified.airline_c = [ s:NM3[0] , s:NM3[1] , s:NM3[2] , s:NM3[3] , '' ]
